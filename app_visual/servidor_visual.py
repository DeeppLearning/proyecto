...
<header>
  ...
  <div class="header-actions">
    <div class="tag-live">DuckDB In-Memory OLAP</div>
    <div class="ds-control">
      <span>Conjunto Activo:</span>
      <select id="selDataset" class="ds-select" onchange="onDatasetChange()">
        <option value="SECOP_INDUSTRIA_TIC_2015_2025.parquet">Industria TIC (213,123 contratos)</option>
...
<main>
    ...
    <div class="card-panel">
      <div class="card-head" style="flex-wrap:wrap; gap:12px; justify-content:space-between">
        <div style="display:flex; gap:10px; align-items:center; flex:1; min-width:280px">
          <input type="text" id="dtSearch" class="search-box" style="flex:1" placeholder="Buscar en los 213,123 contratos por objeto, contratista, entidad, ID o departamento..." onkeydown="if(event.key==='Enter') searchContracts()">
  ...
  <section id="pane-ml" class="tab-content">
    <div class="kpi-row" style="grid-template-columns: repeat(4, 1fr); margin-bottom: 16px;">
      <div class="kpi-box">
        ...
        <div class="kpi-num" id="mlTotalCount">213,123</div>
  ...
  <section id="pane-auditoria" class="tab-content">
    <div class="grid-2" style="margin-bottom:16px">
      <div class="card-panel">
        <div class="card-head">
          <div class="card-heading">Integridad de Archivos Parquet Reales</div>
        ...
        <table class="clean-tbl">
          <tbody>
            ...
            <tr><td>Industria TIC Consolidada (100% Universo Real)</td><td class="num-cell" style="color:var(--success); font-weight:700">213,123 contratos | $40.170.960.614.721 COP ($40.17 Billones)</td></tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="card-panel">
        <div class="card-head">
          <div class="card-heading">Herramientas Técnicas vs. Conceptos del Reto</div>
        </div>
        <table class="clean-tbl">
          <tbody>
...
def run(port=PORT):
    ...
    print(f"Servidor SECOP Analytics activo en http://localhost:{port}")
    try:
